...
ccu_cases = ['not fall into Scenario 2 + 1×workload', 'fall into Scenario 2 + 1×workload']
case_to_file = {'not fall into Scenario 2 + 1×workload':'1', 'fall into Scenario 2 + 1×workload':'2'}
...
for method_idx, method in enumerate(methods):
    ...
    for ccu_case in ccu_cases:
        file_path = f"{method}/{case_to_file[ccu_case]}.csv"
